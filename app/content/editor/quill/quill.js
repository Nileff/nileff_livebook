...
},{"./modules/authorship":21,"./modules/image-tooltip":22,"./modules/keyboard":23,"./modules/multi-cursor":25,"./modules/paste-manager":26,"./modules/toolbar":27,"./modules/tooltip":28,"./modules/undo-manager":29,"./quill":30}],16:[function(_dereq_,module,exports){
...
ImageTooltip = (function(superClass) {
  ...
  ImageTooltip.DEFAULTS = {
    template: '<div class="url"><input class="input" type="textbox"></div>' +
    '<div class="preview"><span>Просмотр</span></div>' +
    '<a href="javascript:;" class="cancel button">Отмена</a>' +
    '<a href="javascript:;" class="insert button">Вставить</a>'
  };
  ...
  ImageTooltip.prototype.insertImage = function() {
    ...
    if (this.range) {
      this.preview.innerHTML = '<span>Просмотр</span>';
      this.textbox.value = '';
      index = this.range.end;
      if(this._matchImageURL(url)) {
  ...
  ImageTooltip.prototype._preview = function() {
    ...
    if (this.preview.firstChild.tagName === 'IMG') {
      return this.preview.firstChild.setAttribute('src', url);
    } else {
...
Quill = (function(superClass) {
  ...
  Quill.DEFAULTS = {
    formats: ['align', 'bold', 'italic', 'strike', 'underline', 'color', 'background', 'font', 'size', 'image', 'bullet', 'list'],
    modules: {
      'keyboard': true,
      'paste-manager': true,
      'undo-manager': true
...
},{"./core/document":8,"./core/editor":9,"./core/format":10,"./core/normalizer":13,"./lib/dom":17,"./lib/range":20,"./themes/base":32,"./themes/snow":33,"eventemitter2":2,"lodash":1,"rich-text/lib/delta":3}],32:[function(_dereq_,module,exports){
...
},{"../../lib/dom":17,"lodash":1}],33:[function(_dereq_,module,exports){
